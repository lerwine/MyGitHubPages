namespace MyGitHubPages
{
    ...
    public class ContentIndex
    {
        ...
        private ContentIndex(DirectoryInfo webRootDir, DirectoryInfo indexRootDir)
        {
            ...
            _webRootUri = AsDirUri(new Uri(webRootDir.FullName));
            _indexRootUri = AsDirUri(new Uri(indexRootDir.FullName));
        ...
        public static Uri AsDirUri(Uri uri)
        {
        ...
        {
            _document.AppendChild(_document.CreateElement("html", ContentExtensions.Xmlns_xhtml));
        ...
        private void AddSvgRow(FileInfo file, XmlElement tr)
        {
            ...
            else
            {
                ...
                XmlNodeList symbols = svgDocument.DocumentElement.SelectNodes("s:defs/s:*[not(count(@id)=0)]", nsmgr);
        ...
        private void AddSvgSymbolRow(XmlElement symbol, string fileName, XmlElement tr)
        {
            ...
            XmlElement svgElement = tr.AddTag("td").AddTag("svg").AddAttribute("class", "fill-light stroke-dark");
        ...
        public Collection<ContentIndex> Crawl()
        {
            ...
            if (!_isEmpty)
            {
                ...
                using (XmlWriter writer = XmlWriter.Create(Path.Combine(_indexRootDir.FullName, "index.html"), settings))
                {
