describe('MyGitHubPages regexTester', function () {
    describe('RegexFlags', function () {
        describe('Constructor', function () {
            it('new regexTester.RegexFlags()', function () {
                let flags = new regexTester.RegexFlags();
            ...
            it('new regexTester.RegexFlags(undefined)', function () {
                let flags = new regexTester.RegexFlags(undefined);
                expect(flags.flags).toEqual("", "#flags");
                expect(flags.global).toEqual(false, "#global");
                expect(flags.ignoreCase).toEqual(false, "#ignoreCase");
                expect(flags.multiline).toEqual(false, "#multiline");
            ...
            it('new regexTester.RegexFlags(null)', function () {
                let flags = new regexTester.RegexFlags(null);
                expect(flags.flags).toEqual("", "#flags");
                expect(flags.global).toEqual(false, "#global");
                expect(flags.ignoreCase).toEqual(false, "#ignoreCase");
                expect(flags.multiline).toEqual(false, "#multiline");
            ...
            [
                { arg0: '', flags: '', global: false, ignoreCase: false, multiline: false, sticky: false, unicode: false },
                { arg0: ' ', flags: '', global: false, ignoreCase: false, multiline: false, sticky: false, unicode: false },
                { arg0: 'a', flags: '', global: false, ignoreCase: false, multiline: false, sticky: false, unicode: false },
                { arg0: 'g', flags: 'g', global: true, ignoreCase: false, multiline: false, sticky: false, unicode: false },
                { arg0: 'i', flags: 'i', global: false, ignoreCase: true, multiline: false, sticky: false, unicode: false },
                { arg0: 'm', flags: 'm', global: false, ignoreCase: false, multiline: true, sticky: false, unicode: false },
                { arg0: 'u', flags: 'u', global: false, ignoreCase: false, multiline: false, sticky: false, unicode: true },
                { arg0: 'y', flags: 'y', global: false, ignoreCase: false, multiline: false, sticky: true, unicode: false },
                { arg0: ' g', flags: 'g', global: true, ignoreCase: false, multiline: false, sticky: false, unicode: false },
                { arg0: 'i ', flags: 'i', global: false, ignoreCase: true, multiline: false, sticky: false, unicode: false },
                { arg0: 'am', flags: 'm', global: false, ignoreCase: false, multiline: true, sticky: false, unicode: false },
                { arg0: 'ua', flags: 'u', global: false, ignoreCase: false, multiline: false, sticky: false, unicode: true },
                { arg0: 'yy', flags: 'y', global: false, ignoreCase: false, multiline: false, sticky: true, unicode: false },
                { arg0: 'gi', flags: 'gi', global: true, ignoreCase: true, multiline: false, sticky: false, unicode: false },
                { arg0: 'mi', flags: 'mi', global: false, ignoreCase: true, multiline: true, sticky: false, unicode: false },
                { arg0: 'mgiyu', flags: 'mgiyu', global: true, ignoreCase: true, multiline: true, sticky: true, unicode: true },
                { arg0: 'gimuy', flags: 'gimuy', global: true, ignoreCase: true, multiline: true, sticky: true, unicode: true },
                { arg0: ' uyixgmz', flags: 'uyigm', global: true, ignoreCase: true, multiline: true, sticky: true, unicode: true }
            ].forEach(function (testData) {
                it('new regexTester.RegexFlags(' + JSON.stringify(testData.arg0) + ')', function () {
                    let flags = new regexTester.RegexFlags(testData.arg0);
                ...
                describe('(' + JSON.stringify(f) + ")", function () {
                    describe('setGlobal', function () {
                        describe('true', function () {
                            ...
                            it('source.global', function () { if (source instanceof regexTester.RegexFlags) {
                                expect(source.global).toEqual(f == 'g');
                            }
                            else {
                                pending(source);
                            } });
                            it('target.global', function () { if (target instanceof regexTester.RegexFlags) {
                                expect(target.global).toEqual(true);
                            }
                            else {
                                pending(target);
                            } });
                            it('source.ignoreCase', function () { if (source instanceof regexTester.RegexFlags) {
                                expect(source.ignoreCase).toEqual(f == 'i');
                            }
                            else {
                                pending(source);
                            } });
                            it('target.ignoreCase', function () { if (target instanceof regexTester.RegexFlags) {
                                expect(target.ignoreCase).toEqual(f == 'i');
                            }
                            else {
                                pending(target);
                            } });
                            it('source.multiline', function () { if (source instanceof regexTester.RegexFlags) {
                                expect(source.multiline).toEqual(f == 'm');
                            }
                            else {
                                pending(source);
                            } });
                            it('target.multiline', function () { if (target instanceof regexTester.RegexFlags) {
                                expect(target.multiline).toEqual(f == 'm');
                            }
                            else {
                                pending(target);
                            } });
                            it('source.unicode', function () { if (source instanceof regexTester.RegexFlags) {
                                expect(source.unicode).toEqual(f == 'u');
                            }
                            else {
                                pending(source);
                            } });
                            it('target.unicode', function () { if (target instanceof regexTester.RegexFlags) {
                                expect(target.unicode).toEqual(f == 'u');
                            }
                            else {
                                pending(target);
                            } });
                            it('source.sticky', function () { if (source instanceof regexTester.RegexFlags) {
                                expect(source.sticky).toEqual(f == 'y');
                            }
                            else {
                                pending(source);
                            } });
                            it('target.sticky', function () { if (target instanceof regexTester.RegexFlags) {
                                expect(target.sticky).toEqual(f == 'y');
                            }
                            else {
                                pending(target);
                            } });
                            it('source.flags', function () { if (source instanceof regexTester.RegexFlags) {
                                expect(source.flags).toEqual(f);
                            }
                            else {
                                pending(source);
                            } });
                            it('target.flags', function () { if (target instanceof regexTester.RegexFlags) {
                        ...
                        describe('false', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setGlobal(false);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                    ...
                    describe('setIgnoreCase', function () {
                        describe('true', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setIgnoreCase(true);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                        ...
                        describe('false', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setIgnoreCase(false);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                    ...
                    describe('setMultiline', function () {
                        describe('true', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setMultiline(true);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                        ...
                        describe('false', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setMultiline(false);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                    ...
                    describe('setUnicode', function () {
                        describe('true', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setUnicode(true);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                        ...
                        describe('false', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setUnicode(false);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
                    ...
                    describe('setSticky', function () {
                        ...
                        describe('false', function () {
                            ...
                            it('invoke', function () {
                                if (source instanceof regexTester.RegexFlags) {
                                    let obj = source.setSticky(false);
                                    expect(obj).toBeDefined();
                                    expect(obj).not.toBeNull();
                                    expect(obj instanceof regexTester.RegexFlags).toEqual(true);
                                }
    ...
    describe('RegexParserService', function () {
        ...
        describe("Callbacks", function () {
            let regexParser;
            let scope;
            beforeEach(inject(function ($rootScope, _regexParser_) {
                regexParser = _regexParser_;
                scope = $rootScope.$new();
            }));
            describe('onRegexPatternChanged', function () {
                it('oldValue', function (done) {
                    regexParser.onRegexPatternChanged(scope, function (event, oldValue, newValue) {
                        expect(oldValue).toEqual('(?:)');
                        done();
                    });
                    regexParser.pattern('^\\s+');
                });
                it('newValue', function (done) {
                    regexParser.onRegexPatternChanged(scope, function (event, oldValue, newValue) {
                ...
                it('regexParser.pattern()', function (done) {
                    regexParser.onRegexPatternChanged(scope, function (event, oldValue, newValue) {
                        let pattern = regexParser.pattern();
            ...
            describe('onRegexFlagsChanged', function () {
                it('oldValue', function (done) {
                    regexParser.onRegexFlagsChanged(scope, function (event, oldValue, newValue) {
                        let flags = regexParser.flags();
                ...
                it('regexParser.flags()', function (done) {
                    regexParser.onRegexFlagsChanged(scope, function (event, oldValue, newValue) {
                        let flags = regexParser.flags();
            ...
            describe('onRegexObjectChanged', function () {
                it('oldValue', function (done) {
                    regexParser.onRegexObjectChanged(scope, function (event, oldValue, newValue) {
                        expect(oldValue).toBeDefined();
                        expect(oldValue).not.toBeNull();
                ...
                it('regexParser.regex()', function (done) {
                    regexParser.onRegexObjectChanged(scope, function (event, oldValue, newValue) {
                        let regexp = regexParser.regex();
